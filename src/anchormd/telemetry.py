"""Local-only telemetry for anchormd usage tracking.

Opt-in via ANCHORMD_TELEMETRY=1 environment variable.
...
_ENV_VAR = "ANCHORMD_TELEMETRY"
_DEFAULT_DIR = Path.home() / ".anchormd"
...
def _telemetry_dir() -> Path:
    """Get the telemetry directory (respects ANCHORMD_DIR env var)."""
    return Path(os.environ.get("ANCHORMD_DIR", str(_DEFAULT_DIR)))
