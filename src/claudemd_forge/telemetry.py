"""Local-only telemetry for claudemd-forge usage tracking.

Opt-in via CLAUDEMD_FORGE_TELEMETRY=1 environment variable.
...
_ENV_VAR = "CLAUDEMD_FORGE_TELEMETRY"
_DEFAULT_DIR = Path.home() / ".claudemd_forge"
...
def _telemetry_dir() -> Path:
    """Get the telemetry directory (respects CLAUDEMD_FORGE_DIR env var)."""
    return Path(os.environ.get("CLAUDEMD_FORGE_DIR", str(_DEFAULT_DIR)))
