...
def init(
    ...
    try:
        ...
        benchmarks_dir = root / ".claudemd" / "benchmarks"
        ...
        console.print("\nNext: [bold]claudemd-forge drift run --model <model>[/bold]")
...
def run(
    ...
    try:
        ...
        from claudemd_forge.drift.reporter import render_terminal_report
        from claudemd_forge.drift.runner import run_benchmarks
        ...
        from claudemd_forge.licensing import has_feature
...
def report(
    ...
    try:
        ...
        from claudemd_forge.drift.storage import load_baseline, load_history
        from claudemd_forge.licensing import has_feature
...
def generate(
    ...
    try:
        ...
        from claudemd_forge.drift.storage import save_benchmarks
        ...
        console.print(
            ...
            f".claudemd/benchmarks/generated.yaml[/green]"
        )
